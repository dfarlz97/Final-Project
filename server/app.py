...
class Appointments(Resource):
    def get(self, appointment_id=None):  # Add appointment_id parameter with a default value of None
    ...
    def post(self):
        ...
        appointment = Appointment(patient=patient, doctor=doctor, day=day, time=time, details=details)
